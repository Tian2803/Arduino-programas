...
const char* password = "3105193491";
...
<html>
  ...
  <body>
    ...
    <table>
      ...
      <tr><td colspan="3" align="center"><button class="button" onmousedown="toggleCheckbox('flash');" ontouchstart="toggleCheckbox('flash');" onmouseup="toggleCheckbox('stop');" ontouchend="toggleCheckbox('stop');">Luz</button></td></tr>                
    </table>
   <script>
